...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // java.awt.image.BufferedImage bImg = downloadNFT("https://ipfs.io/ipfs/bafybeibkkktsqxaz3wvwnna7e2iua5sv25vw76s3wmizxbkd2554t4xgka/images/1170.png");
        // saveImageIOToMongoDB(bImg, "1170");

        byte[] byteArray = loadImageFromMongDB("1170");
        java.awt.image.BufferedImage myBufferedImgFromDB = toBufferedImage(byteArray);
    ...
    private static java.awt.image.BufferedImage downloadNFT(String link) {
    ...
    private static void saveImageIOToMongoDB(java.awt.image.BufferedImage image, String name) {
